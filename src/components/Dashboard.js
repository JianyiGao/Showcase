...
//     const myProjects = this.state.projects.filter(function (decoded) {
//       return decoded._id == this.state.projects.id;
//     });
//     const filtered = myProjects.filter(createFilter(this.state.searchTerm, KEYS_TO_FILTERS));
//
//     return (
